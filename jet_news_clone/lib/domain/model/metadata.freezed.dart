...
abstract class $MetadataCopyWith<$Res> {
  ...
  $Res call({PostAuthor author, String date, int readTimeMinutes});
    ...
    return _then(_value.copyWith(
      ...
      date: date == freezed
          ...
          : date // ignore: cast_nullable_to_non_nullable
              as String,
      readTimeMinutes: readTimeMinutes == freezed
...
class _$_Metadata implements _Metadata {
  ...
  @override
  String toString() {
    return 'Metadata(author: $author, date: $date, readTimeMinutes: $readTimeMinutes)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.readTimeMinutes, readTimeMinutes));
  }
  ...
  int get hashCode => Object.hash(
      ...
      const DeepCollectionEquality().hash(readTimeMinutes));
...
abstract class _Metadata implements Metadata {
  factory _Metadata(
      {required PostAuthor author,
      required String date,
      required int readTimeMinutes}) = _$_Metadata;
